...
export default function CreditPurchase() {
  ...
  return (
    <div className="bg-black flex items-center justify-center min-h-screen p-4 relative">
      ...
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-orange-500 to-red-500 text-white text-center py-5 px-4 z-20">
        ...
        {creditPackages.map((pkg) => (
          <div key={pkg.id} className={pkg.cardStyle}>
            ...
            <div className="mb-5">
              ...
              >
                {pkg.id ? "Processing..." : pkg.buttonText}
              </button>
            </div>
